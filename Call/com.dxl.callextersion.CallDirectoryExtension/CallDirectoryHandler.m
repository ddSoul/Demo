...
//  com.dxl.callextersion.CallDirectoryExtension
//
//  Created by ddSoul on 2018/2/27.
...
- (void)addAllIdentificationPhoneNumbersToContext:(CXCallDirectoryExtensionContext *)context {
    ...
    //
    // Numbers must be provided in numerically ascending order.
    CXCallDirectoryPhoneNumber allPhoneNumbers[] = { 8618511544935, 8618511544936 };
    NSArray<NSString *> *labels = @[ @"骗子", @"骗子2" ];
    NSUInteger count = (sizeof(allPhoneNumbers) / sizeof(CXCallDirectoryPhoneNumber));
